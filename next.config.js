                ...
                headers: [
                    ...
                    },
                    {
                        ...
                        value: process.env.NODE_ENV === 'production'
                            ? "default-src 'self'; script-src 'self' 'unsafe-inline'; style-src 'self' 'unsafe-inline' https://unpkg.com; img-src 'self' data: blob: https://*.tile.openstreetmap.org https://tile.openstreetmap.de https://*.tile.openstreetmap.de https://*.openstreetmap.org https://openweathermap.org; connect-src 'self' wss://nippongo.ashkan-services.de https://api.frankfurter.app https://*.tile.openstreetmap.org https://tile.openstreetmap.de https://*.tile.openstreetmap.de https://*.openstreetmap.org https://unpkg.com https://nominatim.openstreetmap.org https://openweathermap.org; font-src 'self' data:; frame-ancestors 'none'; object-src 'none'; base-uri 'self';"
